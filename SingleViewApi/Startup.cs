    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        services.AddTransient<IGetPersonApiByIdUseCase, GetPersonApiByIdUseCase>(s =>
        {
            ...
            return new GetPersonApiByIdUseCase(personGateway, contactDetailsGateway, dataSourceGateway,
                equalityInformationGateway, cautionaryAlertsGateway, tenureGateway);
        });
        ...
        services.AddTransient<IJigsawGateway, JigsawGateway>(s =>
        {
            ...
            return new JigsawGateway(httpClient, Environment.GetEnvironmentVariable("JIGSAW_LOGIN_URL"),
                Environment.GetEnvironmentVariable("JIGSAW_CUSTOMER_API"),
                Environment.GetEnvironmentVariable("JIGSAW_HOMELESSNESS_API"),
                Environment.GetEnvironmentVariable("JIGSAW_ACCOMMODATION_API"));
        });
        ...
        services.AddTransient<IGetCustomerByIdUseCase, GetCustomerByIdUseCase>(s =>
        {
            ...
            var getHousingBenefitsAccountByAccountRefUseCase =
                s.GetService<IGetHousingBenefitsAccountByAccountRefUseCase>();
            var sharedPlanGateway = s.GetService<ISharedPlanGateway>();
        ...
        services.AddTransient<IGetCombinedSearchResultsByNameUseCase, GetCombinedSearchResultsByNameUseCase>(s =>
        {
            ...
            var getCouncilTaxAccountsByCustomerNameUseCase =
                s.GetService<IGetCouncilTaxAccountsByCustomerNameUseCase>();
            var getHousingBenefitsAccountsByCustomerNameUseCase =
                s.GetService<IGetHousingBenefitsAccountsByCustomerNameUseCase>();
            return new GetCombinedSearchResultsByNameUseCase(getSearchResultsByNameUseCase, getJigsawCustomersUseCase,
                searchSingleViewUseCase, getCouncilTaxAccountsByCustomerNameUseCase,
                getHousingBenefitsAccountsByCustomerNameUseCase);
        });
        ...
        services
            .AddTransient<IGetHousingBenefitsAccountByAccountRefUseCase, IGetHousingBenefitsAccountByAccountRefUseCase>(
                s =>
                {
                    var academyGateway = s.GetService<IAcademyGateway>();
                    var dataSourceGateway = s.GetService<IDataSourceGateway>();
        ...
        services.AddTransient<IGetJigsawNotesUseCase>(s =>
        {
            ...
            var dataSourceGateway = s.GetService<IDataSourceGateway>();
            return new GetJigsawNotesUseCase(jigsawGateway, getJigsawAuthTokenUseCase, getActiveCaseNotesUseCase,
                dataSourceGateway);
        });
        ...
        services.AddTransient<IGetAllNotesUseCase, GetAllNotesUseCase>(s =>
        {
            ...
            return new GetAllNotesUseCase(getNotesUseCase, getJigsawNotesUseCase, getCouncilTaxNotesUseCase,
                getHousingBenefitsNotesUseCase, dataSourceGateway);
        });
        ...
        services.AddTransient<IGetCouncilTaxAccountsByCustomerNameUseCase, GetCouncilTaxAccountsByCustomerNameUseCase>(
            s =>
            {
                var academyGateway = s.GetService<IAcademyGateway>();
                var dataSourceGateway = s.GetService<IDataSourceGateway>();
        ...
        services
            .AddTransient<IGetHousingBenefitsAccountsByCustomerNameUseCase,
                GetHousingBenefitsAccountsByCustomerNameUseCase>(s =>
            {
                var academyGateway = s.GetService<IAcademyGateway>();
                var dataSourceGateway = s.GetService<IDataSourceGateway>();
