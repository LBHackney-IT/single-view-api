...
public class JigsawGateway : IJigsawGateway
{
    ...
    public JigsawGateway(HttpClient httpClient, string authUrl, string customerBaseUrl, string homelessnessBaseUrl,
...

    {
        try
        {
            ...
            var form = new FormUrlEncodedContent(jigsawCredentials);
    ...
    public async Task<List<JigsawCustomerSearchApiResponseObject>> GetCustomers(string firstName, string lastName,
        string bearerToken)
...
#nullable disable
        ...
        if (response.StatusCode == HttpStatusCode.OK)
            ...
            {
                Console.WriteLine($"------ DEBUG ----- CustomerById Gateway -- Exception is {e}");
            }
...
#nullable disable
    ...
    [LogCall]
    public async Task<JigsawCasePlacementInformationResponseObject> GetCaseAccommodationPlacementsByCaseId(
        string caseId, string bearerToken)
    {
...
#nullable disable
    ...
    [LogCall]
    public async Task<JigsawCaseAdditionalFactorsResponseObject> GetCaseAdditionalFactors(string caseId,
        string bearerToken)
    {
...
#nullable disable
    ...
    [LogCall]
    public async Task<JigsawCaseAdditionalFactorsResponseObject> GetCaseHealthAndWellBeing(string caseId,
        string bearerToken)
    {
...
#nullable disable
    ...
    public async Task<JigsawHouseholdCompositionResponseObject> GetHouseholdCompositionByCaseId(string caseId,
        string bearerToken)
    {
        ...
        if (response.StatusCode == HttpStatusCode.OK)
        {
            ...
            try
            {
                householdComposition =
                    JsonConvert.DeserializeObject<JigsawHouseholdCompositionResponseObject>(jsonBody);
            }
            catch (Exception e)
            {
