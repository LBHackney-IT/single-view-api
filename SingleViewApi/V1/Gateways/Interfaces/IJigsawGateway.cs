...
public interface IJigsawGateway
{
    ...
    Task<List<JigsawCustomerSearchApiResponseObject>> GetCustomers(string firstName, string lastName,
        string bearerToken);
    ...
    Task<JigsawCasePlacementInformationResponseObject> GetCaseAccommodationPlacementsByCaseId(string caseId,
        string bearerToken);
