...
public class GetJigsawNotesUseCase : IGetJigsawNotesUseCase
{
    ...
    public GetJigsawNotesUseCase(IJigsawGateway jigsawGateway, IGetJigsawAuthTokenUseCase getJigsawAuthTokenUseCase,
        IGetJigsawActiveCaseNotesUseCase getCaseNotesUseCase, IDataSourceGateway dataSourceGateway)
    {
            ...
            foreach (var note in customerNotes)
                notes.Add(
                    new NoteResponseObject
                    {
                        ...
                        Categorisation =
                            new Categorisation { Description = $"Jigsaw NoteTypeId: {note.NoteTypeId}" },
