...
public class Placement
{
    ...
    [JsonProperty("fullAddressDetails")]
    public FullAddressDetails FullAddressDetails { get; set; }

    [JsonProperty("placementDuty")]
    ...
    [JsonProperty("depositInScheme")]
    public bool DepositInScheme { get; set; }
...
#nullable enable
    ...
    [JsonProperty("bondEndDate")]
    public string? BondEndDate { get; set; }

    [JsonProperty("deposit")]
    public int? Deposit { get; set; }

    [JsonProperty("placementTypeDetails")]
    public string? PlacementTypeDetails { get; set; }

    [JsonProperty("placementDutyDetails")]
    public string? PlacementDutyDetails { get; set; }
