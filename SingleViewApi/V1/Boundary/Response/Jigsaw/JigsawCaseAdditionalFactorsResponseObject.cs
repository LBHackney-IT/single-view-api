...
public class JigsawCaseAdditionalFactorsResponseObject
{
    ...
    [JsonProperty("isBuddyForm")] public bool IsBuddyForm { get; set; }

    [JsonProperty("questionGroups")] public List<QuestionGroup> QuestionGroups { get; set; }

    [JsonProperty("mapCode")] public string MapCode { get; set; }
}
...
{
    [JsonProperty("selectedValue")] public string SelectedValue { get; set; }

    [JsonProperty("options")] public List<Option> Options { get; set; }

    [JsonProperty("triggerQuestions")] public List<object> TriggerQuestions { get; set; }

    [JsonProperty("questionType")] public int QuestionType { get; set; }

    [JsonProperty("label")] public string Label { get; set; }

    [JsonProperty("questionMapCode")] public string QuestionMapCode { get; set; }

    [JsonProperty("startNewLine")] public bool StartNewLine { get; set; }
...
public class QuestionGroup
{
    ...
    [JsonProperty("legend")] public string Legend { get; set; }
