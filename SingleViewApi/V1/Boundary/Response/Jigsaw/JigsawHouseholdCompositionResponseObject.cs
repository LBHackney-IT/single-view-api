...
{
    [JsonProperty("casePersonId")] public int CasePersonId { get; set; }

    [JsonProperty("referralPersonId")] public int? ReferralPersonId { get; set; }

    [JsonProperty("isLead")] public bool IsLead { get; set; }

    [JsonProperty("id")] public int Id { get; set; }

    [JsonProperty("personTitleId")] public int PersonTitleId { get; set; }

    [JsonProperty("relationshipId")] public int? RelationshipId { get; set; }

    [JsonProperty("genderId")] public int GenderId { get; set; }

    [JsonProperty("customerId")] public int CustomerId { get; set; }

    [JsonProperty("personTitle")] public string PersonTitle { get; set; }
...
#nullable enable
    ...
    [JsonProperty("pregnancyDueDate")] public string? PregnancyDueDate { get; set; }

    [JsonProperty("housingCircumstance")] public string? HousingCircumstance { get; set; }
    ...
    [JsonProperty("homePhoneNumber")] public string? HomePhoneNumber { get; set; }

    [JsonProperty("supportWorkerId")] public int? SupportWorkerId { get; set; }

    [JsonProperty("contactMethodId")] public int? ContactMethodId { get; set; }

    [JsonProperty("contactMethod")] public string? ContactMethod { get; set; }

    [JsonProperty("customerReference")] public string? CustomerReference { get; set; }

    [JsonProperty("workPhoneNumber")] public string? WorkPhoneNumber { get; set; }

    [JsonProperty("moveInDate")] public DateTime? MoveInDate { get; set; }
    ...
    [JsonProperty("addressString")] public string? AddressString { get; set; }

    [JsonProperty("address")] public HouseholdCompositionAddress? Address { get; set; }

    [JsonProperty("accommodationTypeId")] public int? AccommodationTypeId { get; set; }

    [JsonProperty("housingCircumstanceId")]
    public int? HousingCircumstanceId { get; set; }

    [JsonProperty("isSettled")] public bool? IsSettled { get; set; }

    [JsonProperty("okToContactOnHomePhoneNumber")]
    public bool? OkToContactOnHomePhoneNumber { get; set; }

    [JsonProperty("mobilePhoneNumber")] public string? MobilePhoneNumber { get; set; }
    ...
    [JsonProperty("okToContactOnEmail")] public bool? OkToContactOnEmail { get; set; }

    [JsonProperty("contactDetailsId")] public int? ContactDetailsId { get; set; }

    [JsonProperty("supportWorker")] public JigsawSupportWorker? SupportWorker { get; set; }

    [JsonProperty("gender")] public string? Gender { get; set; }

    [JsonProperty("householdMemberType")] public int? HouseholdMemberType { get; set; }
...
{
    [JsonProperty("people")] public List<JigsawHouseholdPerson> People { get; set; }
}
