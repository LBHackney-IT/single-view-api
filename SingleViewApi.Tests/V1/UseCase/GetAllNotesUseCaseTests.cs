...
public class GetAllNotesUseCaseTests : LogCallAspectFixture
{
    ...
    public void SetUp()
    {
        ...
        _classUnderTest = new GetAllNotesUseCase(_mockGetNotesUseCase.Object, _mockGetJigsawNotesUseCase.Object,
            _mockGetCouncilTaxNotesUseCase.Object, _mockGetHousingBenefitsNotesUseCase.Object,
    ...
    public async Task GetsAllNotes()
    {
        ...
        {
            Notes = notesFixture, SystemIds = systemIdListFixture.SystemIds
        };
        notesResponseFixture.Sort();

        _mockGetNotesUseCase.Setup(x =>
                x.Execute(personApiSystemId, userToken, paginationToken, pageSize))
            .ReturnsAsync(notesApiNoteResponseObjectListFixture);
    ...
    public async Task IgnoresJigsawNotesIfRedisKeyIsNull()
    {
        ...
        var systemIdListFixture = new SystemIdList { SystemIds = new List<SystemId> { jigsawSystemIdFixture } };
        var systemIds = systemIdListFixture.ToJson();
        var userToken = _fixture.Create<string>();
