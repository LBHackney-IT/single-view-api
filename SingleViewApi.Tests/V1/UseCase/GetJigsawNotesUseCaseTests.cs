...
public class GetJigsawNotesUseCaseTests : LogCallAspectFixture
{
    ...
    public void SetUp()
    {
        ...
        _classUnderTest =
            new GetJigsawNotesUseCase(_mockJigsawGateway.Object, _mockGetJigsawAuthTokenUseCase.Object,
                _mockGetJigsawActiveCaseNotesUseCase.Object, _mockDataSourceGateway.Object);
    ...
    public async Task GetsNotes()
    {
        ...
        var authGatewayResponseFixture = new AuthGatewayResponse { Token = _fixture.Create<string>() };
        ...
        _mockJigsawGateway.Setup(x =>
                x.GetCustomerNotesByCustomerId(idFixture, authGatewayResponseFixture.Token))
            .ReturnsAsync(jigsawNotesFixture);
