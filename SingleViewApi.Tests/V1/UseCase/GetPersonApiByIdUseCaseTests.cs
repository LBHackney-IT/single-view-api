...
public class GetPersonApiByIdUseCaseTests : LogCallAspectFixture
{
    ...
    public void SetUp()
    {
        ...
        _classUnderTest = new GetPersonApiByIdUseCase(_mockPersonGateway.Object, _mockContactDetailsGateway.Object,
            _mockDataSourceGateway.Object, _mockEqualityInfoGateway.Object, _mockCautionaryAlertsGateway.Object,
            _mockTenureGateway.Object);
    ...
    public async Task GetsACustomerFromPersonApi()
    {
        ...
        _mockContactDetailsGateway.Setup(x => x.GetContactDetailsById(id, userToken))
            .ReturnsAsync(stubbedContactDetails);
        ...
        _mockCautionaryAlertsGateway.Setup(x => x.GetCautionaryAlertsById(id, userToken))
            .ReturnsAsync(stubbedCautionaryAlerts);

        _mockTenureGateway.Setup(x => x.GetTenureInformation(stubbedTenure.Id, userToken))
            .ReturnsAsync(stubbedTenureInfo);
        ...
        result.Customer.PreferredTitle.Should().BeEquivalentTo(stubbedPerson.PreferredTitle.GetDisplayName());
        ...
        result.Customer.AllContactDetails[0].AddressExtended.Should()
            .BeEquivalentTo(stubbedContactDetails[0].ContactInformation.AddressExtended);
        result.Customer.AllContactDetails[0].ContactType.Should()
            .BeEquivalentTo(stubbedContactDetails[0].ContactInformation.ContactType.ToString());
        ...
        result.Customer.AllContactDetails[0].Description.Should()
            .BeEquivalentTo(stubbedContactDetails[0].ContactInformation.Description);
        ...
        result.Customer.AllContactDetails[0].SourceServiceArea.Should()
            .BeEquivalentTo(stubbedContactDetails[0].SourceServiceArea.Area);
        result.Customer.AllContactDetails[0].SubType.Should()
            .BeEquivalentTo(stubbedContactDetails[0].ContactInformation.SubType.ToString());
        result.Customer.AllContactDetails[0].Value.Should()
            .BeEquivalentTo(stubbedContactDetails[0].ContactInformation.Value);
